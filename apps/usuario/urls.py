...
from apps.usuario.views import usuarios_registrar, usuarios_modificar, cargar_usuario_formulario, login_user, logout_user
...
urlpatterns = [
    ...
    # path('buscar/', buscar_usuario, name='buscar-usuario'),#Buscar usuario por correo y contraseña
